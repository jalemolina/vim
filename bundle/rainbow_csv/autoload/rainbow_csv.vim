...
let s:pairs = [['darkred', 'cornsilk4'], ['darkblue', 'DeepPink'], ['darkgreen', 'DeepSkyBlue1'], ['darkmagenta', 'chartreuse'], ['darkcyan', 'OrangeRed'], ['red', 'gold'], ['blue', 'MediumSlateBlue'], ['green', 'red1'], ['magenta', 'DodgerBlue'], ['NONE', 'NONE']]
